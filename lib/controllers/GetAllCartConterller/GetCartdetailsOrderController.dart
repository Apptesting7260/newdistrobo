...
class GetAllorderCartController extends GetxController {
  final _api = ApiRepo();
  //int? seekerRequestlenght;
  final getAllCartModel = OrderDetailsTocart().obs;
  final rxRequestStatus = Status.LOADING.obs;
  var checkindex = 0.obs;
  RxString error = ''.obs;

  void setRxRequestStatus(Status value) => rxRequestStatus.value = value;
  void setUserList(OrderDetailsTocart value) => getAllCartModel.value = value;
  ...
  Future<void> GetAllCartModelApiHit() async {
    ...
    _api.OrderDetailsTocartOrderDetailsTocart(data).then((value) {
