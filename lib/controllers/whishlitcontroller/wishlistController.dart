...
class WhishlistAddController extends GetxController {
  ...
  Future<void> ProductSearchWhishLisAddPageApi( categoryDetails,) async {
    ...
    _api.addWishlist(data).then((value) {
      ...
      productSearchController.ProductSearch.value
          .productCategory![categoryDetails].productWishlist= productSearchController.ProductSearch.value
          .productCategory![categoryDetails].productWishlist==false?true:false;
      productSearchController.ProductSearch.value
          .productCategory![categoryDetails].isLoding.value=false;
