...
import '../SearchController/ProductSearchController.dart';
...
class AddToCartController extends GetxController {
  ...
  Future<void> ProductSearchToCartApiHit(int index) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var user=prefs.getString("userId");
    Map data = {
      'quantity':'1',
    ...
    _api.AddToCartApi(data).then((value) {
      ...
      productSearchController
          .ProductSearch.value.productCategory![index].productCartKey="true";
      productSearchController
          .ProductSearch.value.productCategory![index].productKey=key;
      productSearchController
          .ProductSearch.value.productCategory![index].productlocalCartQuantity.value=1;

      productSearchController
          .ProductSearch.value.productCategory![index].cartLoding.value=false;
      print(value);
      print("Succes");
