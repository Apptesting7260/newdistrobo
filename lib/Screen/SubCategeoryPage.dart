                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 15.0),
                        child:ProductCategoryLists![index].perItemPrice==""?
                        Row(
                          children: [

                            Text(
                              "\$${ProductCategoryLists![index].productPrice.toString()}"
                              ,
                              overflow: TextOverflow.ellipsis,
                        ...
                        Row(
                          children: [
                            Text(
                              "\$${ProductCategoryLists![index].perItemPrice.toString()}/ea "
                              ,
                              overflow: TextOverflow.ellipsis,
                            ...
                            Text(
                              "\$${ProductCategoryLists![index].productPrice.toString()}/case"
                              ,
                              overflow: TextOverflow.ellipsis,
