...
import '../../controllers/SearchController/CategorySearchController.dart';
...
class _CategorySearchPageState extends State<CategorySearchPage> {
  CategorySearchController productSearchController =
  ...
  void initState() {
    ...
    productSearchController.CategorySearchApi();
    super.initState();
  }
        ...
        appBar: AppBar(
            ...
            title: TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  hintStyle: TextStyle(fontSize: 12, color: Color(0xffBABABA)),
                  ...
                  suffixIcon: teXtData==true? IconButton(
                      onPressed: () {
                       setState(() {
                        ...
                        productSearchController.searchController.value.clear();
                        Get.back();
                      },
                    ...
                    case Status.COMPLETED:
                      return Container(
                        child: productSearchController.ProductSearch.value
                            ...
                            child:  EmptyCart())
                            : ListView.separated(
                          itemCount:  productSearchController.ProductSearch.value
                              .productCategorySearching!.searchCategory!.length,
                          shrinkWrap: true,
                            ...
                            return Padding(
                              ...
                              child: Container(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    categoryId = null;
                                    categoryId =  productSearchController.ProductSearch.value
                                        .productCategorySearching!.searchCategory![index].categoryId
                                        .toString();
                                    setState(() {});
                                    if ( productSearchController.ProductSearch.value
                                        .productCategorySearching!.searchCategory![index].subcategoriesExist ==
                                        "true") {
                                      if (categoryId != null) {
                                        Get.to(ShopDetailsPage(
                                            title:  productSearchController.ProductSearch.value
                                                .productCategorySearching!.searchCategory![index]
                                                .categoryName));
                                      }
                                    }
                                    else {
                                      ...
                                      categoryId =   productSearchController.ProductSearch.value
                                          ...
                                          .categoryId
                                          .toString();
                                      categoryName =   productSearchController.ProductSearch.value
                                          .productCategorySearching!.searchCategory![index]
                                          .categoryName;
                                      print(categoryId);
                                                ...
                                                if ( productSearchController.ProductSearch.value
                                                  ...
                                                  if (categoryId != null) {
                                                    Get.to(ShopDetailsPage(
                                                        title:
                                                        productSearchController.ProductSearch.value
                                                            .productCategorySearching!.searchCategory![
                                                        index]
                                                            .categoryName));
                                                  }
                                                } else {
