...
import 'package:flutter/services.dart';
import 'package:get/get.dart';
import 'package:newdistrobo/Screen/HomePage.dart';
import 'package:newdistrobo/Screen/MyCart.dart';
import 'package:newdistrobo/Screen/MyFaveroutList.dart';
import 'package:newdistrobo/Screen/MyProfile.dart';
import 'package:newdistrobo/Screen/ShopPage.dart';
import 'package:newdistrobo/Widgets/botton_navigation.dart';
...
class _Tab_viewState extends State<Tab_view> {
  ...
  AddToCartController addToCartController = Get.put(AddToCartController());
  HomePageController homeComtroller = Get.put(HomePageController());
  GetCartDetailsController getCartDetailsController = Get.put(GetCartDetailsController());
  int? bottomSelectedIndex;
  PageController? pageController;
  DateTime currentBackPressTime = DateTime.now();
  bool loading = false;
