class AppUrl {
  ...
  static const String homeApi =
      '${baseUrl}v1/home_api';
  static const String aboutUsApi =
      '${baseUrl}v1/about-us';
...
static const String subproCategarory =
  ...
  static const String nameUpdate =
  ...
  static const String phoneUpdate =
      '${baseUrl}v1/phonenumber_update';
  static const String changePass =
      '${baseUrl}v1/password_update';
  static const String newArrival =
      '${baseUrl}v1/latest-products';
